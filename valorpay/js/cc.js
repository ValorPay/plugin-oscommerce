$(document).ready(function () {
    ...
    window.ValorPayCreateCCForm = function() 
    {
        ...
        if ($('input[name=payment][value="valorpay"]').is(':checked')){
            ...
            if( valorpay_avs_options == 'zipandaddress' ) valorpay_avs_string = '<div class="row"><div class="col-75"><label for="valorpay-card-address">Address <span class="required">*</span></label><input type="text" id="valorpay-card-address" name="valorpay-card-address" value=""><div id="valorpay-card-address-error" class="required-message-wrap top-error-mes"><div class="required-message" style="">Please enter address for verification.</div></div></div><div class="col-25"><label for="valorpay-card-zip">Zip <span class="required">*</span></label><input type="text" id="valorpay-card-zip" name="valorpay-card-zip" value=""><div id="valorpay-card-zip-error" class="required-message-wrap top-error-mes"><div class="required-message" style="">Please enter zip for verification.</div></div></div></div>';
            else if( valorpay_avs_options == 'address' ) valorpay_avs_string = '<div class="row"><div class="col-75"><label for="valorpay-card-address">Address <span class="required">*</span></label><input type="text" id="valorpay-card-address" name="valorpay-card-address" value=""><div id="valorpay-card-address-error" class="required-message-wrap top-error-mes"><div class="required-message" style="">Please enter address for verification.</div></div></div></div>';
