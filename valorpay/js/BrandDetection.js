ValorPayBrandDetection = function() {
};

ValorPayBrandDetection.prototype.option =
{
	'minlength': 6
};

ValorPayBrandDetection.prototype.creditcard =
{
	'carte-bleue': {
...
ValorPayBrandDetection.prototype.hasOwnProperty = function(property) {
	return this[property] !== undefined;
};

ValorPayBrandDetection.prototype.detect = function(cardnumber)
{
	var brand = 'unknown';
...
ValorPayBrandDetection.prototype.validate = function(cardnumber)
{
...
ValorPayBrandDetection.prototype.luhn = function(cardnumber)
{
	//todo
};